...
static const u8 sDoorAnimTiles_Santana[] = INCGFX_U8("graphics/door_anims/santana.png", ".4bpp");
static const u8 sDoorAnimTiles_MatiasLab[] = INCGFX_U8("graphics/door_anims/matias_lab.png", ".4bpp");
static const u8 sDoorAnimTiles_MapleRanch[] = INCGFX_U8("graphics/door_anims/maple_ranch.png", ".4bpp");
static const u8 sDoorAnimTiles_Nevulosa[] = INCGFX_U8("graphics/door_anims/nevulosa.png", ".4bpp");
...
// Strawberry Door Palette
static const u8 sDoorAnimPalettes_Santana[] = {6, 6, 6, 6, 6, 6, 6, 6};
static const u8 sDoorAnimPalettes_MapleRanch[] = {8, 8, 8, 8, 8, 8, 8, 8};
static const u8 sDoorAnimPalettes_Nevulosa[] = {9, 9, 9, 9, 9, 9, 9, 9};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    // Strawberry Door Anim
    {METATILE_Petalburg_Door_Santana,                       &gTileset_Petalburg, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Santana, sDoorAnimPalettes_Santana},
    {METATILE_Petalburg_Door_Matias_Lab,                    &gTileset_Petalburg, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_MatiasLab, sDoorAnimPalettes_Santana},
    {METATILE_Petalburg_Door_Maple_Ranch,                   &gTileset_Petalburg, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_MapleRanch, sDoorAnimPalettes_MapleRanch},
    {METATILE_Petalburg_Door_Nevulosa,                      &gTileset_Petalburg, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Nevulosa, sDoorAnimPalettes_Nevulosa},
