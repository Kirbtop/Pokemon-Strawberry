...
#define VERSION_BANNER_Y_GOAL 41
...
static const u32 sTitleScreenRayquazaGfx[] = INCGFX_U32("graphics/title_screen/StrawberryTitle.png", ".4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/StrawberryTitle.bin.smolTM");
